def tab_q():
    ...
    df1 = [168,175,162,183,157,170,179,155,188,165]
    df1 = pd.DataFrame(df1, columns = ["Körpergröße in cm"])
    c1 = "Verhältnis"
    df7 = [68.5,73.2,61.8,85.0,57.6,70.9,76.3,63.7,92.4,67.1]
    df7 = pd.DataFrame(df7, columns = ["Körpergewicht in kg"])
    c7 = "Verhältnis"
    df9 = [22.5,15.8,29.2,18.6,26.7,10.9,30.1,23.4,17.2,20.3]
    df9 = pd.DataFrame(df9, columns = ["Temperatur (in °C)"])
    c9 = "Intervall"
    ...
    c6 = "Intervall"
    df2 = ["Hamburg","München","Berlin","Köln","Frankfurt","Stuttgart","Düsseldorf","Leipzig","Dresden","Nürnberg"]
    df2 = pd.DataFrame(df2, columns = ["City"])
    c2 = "Nominal"
    ...
    df8["Female"] = df82
    c8 = "Nominal"
    df3 = ["Ali Öztürk","Sophia Nguyen","David Müller","Amina Al-Mansoori",
    "Lukas Patel","Lea Kim","Amir Kowalski","Ebru Garcia","Timo Meier","Aisha Schmidt"]
    df3 = pd.DataFrame(df3, columns = ["Studentenname"])
    c3 = "Nominal"
    ...
    types = ["Nominal","Ordinal","Intervall","Verhältnis"]
